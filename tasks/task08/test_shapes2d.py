...
class TestSquare(unittest.TestCase):
    ...
    def test_init_sqr_bot(self): # ValueError
        with self.assertRaisesRegex(ValueError, "Type of bottom left point must be Point2D"):
            Square({"a": 2, "b": 6}, 5)

    def test_init_sqr_side(self): # ValueError
...
class TesthSape2DCollection(unittest.TestCase):
    ...
    def test_init_shapes_2d(self): # ValueError
    ...
    def test_init_shapes_list(self): # ValueError
